...
const topPart = `import { Link, Navigate } from "react-router";
              ...
              <div className="analytic-card">
                <div className="analytic-card-body p-3">
                  <div className="row g-2">
                    ...
                    <div className="col-4">
                      <button onClick={() => setShowAddAppointment(true)} className="action-pill border-0" style={{ background: '#eef2ff' }}>
                        <div className="action-pill-icon" style={{ color: '#4f46e5' }}><i className="ti ti-calendar-plus" /></div>
                        <span className="action-pill-text" style={{ color: '#4f46e5' }}>Appt</span>
                      </button>
                    </div>
                    <div className="col-4">
                      <Link to={all_routes.addDoctors} className="action-pill">
                        <div className="action-pill-icon" style={{ color: '#10b981' }}><i className="ti ti-stethoscope" /></div>
                ...
                <div className="analytic-card-body" style={{ maxHeight: '340px', overflowY: 'auto', paddingRight: '12px' }}>
                  {todayAppointmentsList.length === 0 ? (
                    <div className="text-center py-5">
                      <i className="ti ti-calendar-off fs-40 text-slate-300 mb-3 d-block" style={{ color: '#cbd5e1' }} />
            ...
            <div className="modal-body p-4" style={{ maxHeight: '75vh', overflowY: 'auto' }}>
              {showAddAppointment && (
                <AppointmentFormPage
                  mode="create"
                  isModal={true}
                  onModalClose={() => setShowAddAppointment(false)}
                />
              )}
            </div>
          </div>
...
fs.writeFileSync('c:\\Users\\somya\\OneDrive\\Desktop\\projects\\docyatri\\clinic-product-frontend\\src\\feature-module\\components\\pages\\dashboard\\dashboard.tsx', topPart + bottomPart);
