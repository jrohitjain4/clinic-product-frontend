  ...
  },
  {
    ...
    submenuItems: [
      ...
      },
      {
        ...
        dot: true,
        submenuItems: [
          { label: "Dashboard", link: routes.ipdDashboard },
          { label: "Patient", link: routes.ipdPatients },
          { label: "Admission", link: routes.ipdAdmissions },
          { label: "Discharge", link: routes.ipdDischarge },
          { label: "Ward Management", link: routes.ipdWardManagement },
          { label: "Billings & Invoices", link: routes.ipdBillings },
          { label: "Doctor", link: routes.ipdDoctors },
          { label: "Treatment & Packages", link: routes.ipdTreatments },
        ],
      },
      {
        label: "Diagnostic",
        ...
        dot: true,
        submenuItems: [
          { label: "Dashboard", link: routes.pathlabDashboard },
          { label: "Category", link: routes.pathlabCategories },
          { label: "Diagnostic Test", link: routes.pathlabTests },
          { label: "Diagnostic Booking", link: routes.pathlabBookings },
          { label: "Invoice", link: routes.pathlabInvoices },
        ],
      },
      {
        label: "Pharmacy",
        ...
        dot: true,
        submenuItems: [
          { label: "Dashboard", link: routes.pharmacyDashboard },
          { label: "Category", link: routes.pharmacyCategories },
          { label: "Medicine", link: routes.pharmacyMedicines },
          { label: "Inventory", link: routes.pharmacyInventory },
          { label: "Pharmacy Billing", link: routes.pharmacyBilling },
          { label: "Sales History", link: routes.pharmacySalesHistory },
        ],
      },
      {
        label: "HRM",
        ...
        dot: true,
        submenuItems: [
          { label: "Staffs", link: routes.staffs },
          { label: "Departments", link: routes.hrmDepartments },
          { label: "Designation", link: routes.designation },
          { label: "Attendance", link: routes.attendance },
          {
            label: "Leaves",
            link: "index",
            submenu: true,
          ...
          { label: "Payroll", link: routes.payroll },
        ],
      },
      {
        ...
        submenuItems: [
          ...
          { label: "Invoices", link: routes.invoices + "?type=clinic" },
      ...
      },
      {
        ...
        dot: true,
        submenuItems: [
          { label: "To Do", link: routes.todoList },
          { label: "Notes", link: routes.notes },
        ],
      },
    ],
  },
