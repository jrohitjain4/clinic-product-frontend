...
const CategoryManagement = () => {
  const { categories, loading, createCategory, updateCategory, deleteCategory, bulkDeleteCategories } = useLabCategories();
  ...
  const columns = [
    ...
    },
    {
      title: "Tests",
      dataIndex: "TestCount",
      render: (text: number) => <span className="badge badge-soft-info border border-info px-2 py-1 fs-12 fw-medium">{text}</span>,
      sorter: (a: any, b: any) => a.TestCount - b.TestCount,
      width: 80,
    },
    {
      title: "Created Date",
    ...
    },
    {
      ...
      render: (_text: string, record: any) => (
        <div className="d-flex align-items-center justify-content-center gap-2">
          <Link to="#" className="bg-transparent border-0 text-info p-1" title="View Details" onClick={(e) => { e.preventDefault(); setViewCategory(record.raw); triggerModal("view_category"); }}>
  ...
  return (
    <>
        ...
        <div className="content">
          ...
          {loading ? (
            ...
            <div className="border rounded bg-white">
              <EmptyState title="No categories yet" message="Create your first diagnostic category to organize lab tests." />
            </div>
          ) : (
          ...
          {selectedIds.length > 0 && (
            <div className="d-flex justify-content-center pt-4 pb-4 sticky-delete-bar">
              <button className="btn btn-danger d-flex align-items-center gap-2 px-4 py-2 shadow" onClick={() => triggerModal("bulk_delete_category")} style={{ borderRadius: "8px", minHeight: "42px", fontWeight: "bold" }}>
          ...
          <div className="modal-dialog modal-dialog-centered" style={{ zIndex: 1050 }}>
            <div className="modal-content border-0 shadow-lg" style={{ borderRadius: '12px', overflow: 'hidden' }}>
              <div className="modal-header bg-primary text-white">
                <h5 className="modal-title text-white">Add Diagnostic Category</h5>
              ...
              <form onSubmit={handleAddSubmit}>
                <div className="modal-body p-4">
                  <div className="mb-3">
                    ...
                    <IconFormControl fieldLabel="category" type="text" placeholder="e.g. Blood Test" value={formName} onChange={(e) => setFormName(e.target.value)} required />
                  </div>
                  <div className="mb-3">
      ...
      {showEditModal && (
        <div className="modal fade show d-block" style={{ zIndex: 1050 }}>
          ...
          <div className="modal-dialog modal-dialog-centered" style={{ zIndex: 1050 }}>
            <div className="modal-content border-0 shadow-lg" style={{ borderRadius: '12px', overflow: 'hidden' }}>
              <div className="modal-header bg-primary text-white">
                <h5 className="modal-title text-white">Edit Diagnostic Category</h5>
          ...
          <div className="modal-content border-0 shadow-lg" style={{ borderRadius: "12px", overflow: "hidden" }}>
            <div className="modal-body text-center position-relative z-1 pt-5 pb-5">
              ...
              <div className="d-flex justify-content-center gap-2">
                <button id="btn-close-bulk-delete-category" type="button" className="btn btn-light position-relative z-1 px-4" data-bs-dismiss="modal">Cancel</button>
      ...
      {/* VIEW MODAL */}
      <ViewModal id="view_category" title="Category Details" subtitle="View category information" headerIcon={<i className="ti ti-tags" />}
        ...
        details={[
          { icon: <i className="ti ti-tags" />, label: "Category Name", value: viewCategory?.name || "—" },
          { icon: <i className="ti ti-microscope" />, label: "Total Tests", value: (viewCategory?._count?.tests ?? 0).toString() },
