                    ...
                    <div className="d-flex align-items-center gap-3">
                      {(prescription as any).clinic?.landingPage?.logo && (
                        <div className="avatar avatar-xxl rounded bg-light border p-2">
                          <ImageWithBasePath src={(prescription as any).clinic.landingPage.logo} alt="clinic" className="img-fluid" />
                        </div>
                      )}
                      <div>
                        <h5 className="text-dark fw-bold mb-1">{(prescription as any).clinic?.name || (prescription as any).clinicName || "Preclinic Central"}</h5>
                        <p className="mb-2 text-muted fs-13 d-flex align-items-center gap-1">
                          <i className="ti ti-map-pin" />
                          {(prescription as any).clinic?.address || (prescription as any).location || "City Med Tower, 4F"}
                        </p>
                        <p className="mb-1 fw-semibold text-dark">{doctor.fullName || "-"}</p>
