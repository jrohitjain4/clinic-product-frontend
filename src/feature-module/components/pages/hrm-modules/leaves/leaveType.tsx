...
const LeaveType = () => {
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      setSelectedIds([]);
      toast.success(`${successCount} leave types deleted successfully`);
      document.getElementById("btn-close-bulk-delete-leave-type")?.click();
    } catch (e: any) {
      toast.error(e?.message || "Failed to delete leave types");
    } finally {
  ...
  return (
    <>
          ...
          {selectedIds.length > 0 && (
            <div className="d-flex justify-content-center pt-4 pb-4 sticky-delete-bar">
              <button
                ...
                data-bs-toggle="modal"
                data-bs-target="#bulk_delete_leave_type_modal"
                style={{
                  borderRadius: "8px",
                  minHeight: "42px",
                  fontWeight: "bold",
      ...
      {/* ===== BULK DELETE MODAL ===== */}
      <div className="modal fade" id="bulk_delete_leave_type_modal">
          ...
          <div className="modal-content border-0 shadow-lg" style={{ borderRadius: "12px", overflow: "hidden" }}>
            <div className="modal-body text-center position-relative z-1 pt-5 pb-5">
              ...
              <p className="text-muted mb-4">
                Are you sure you want to delete selected leave types?
              </p>
              <div className="d-flex justify-content-center gap-2">
                <button
                  id="btn-close-bulk-delete-leave-type"
                  type="button"
