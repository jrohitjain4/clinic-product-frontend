        ...
        <div className="content">
          ...
          <div className="card">
            <div className="card-body">
              <p>
                At Docyari, we value your privacy and are committed to
                protecting your personal data. This Privacy Policy explains how
                we collect, use, disclose, and safeguard your information when
                you access and use our Docyari Platform, including features
              ...
              <div className="mb-0">
                ...
                <p className="mb-0">
                  ...
                  use of the Docyari platform signifies your acceptance of any
                  updates.
                </p>
              </div>
            </div>
