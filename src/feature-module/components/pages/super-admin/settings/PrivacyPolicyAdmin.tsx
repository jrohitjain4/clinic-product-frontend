                    ...
                    <div className="col-md-12">
                        <div className="card">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <h4 className="card-title mb-0">Privacy Policy Content</h4>
                                {isEditing ? (
                                    <div>
                                        <button
                                ...
                                <div className="form-group mb-0">
                                    {isEditing ? (
                                        ...
                                        <div
                                            ...
                                            dangerouslySetInnerHTML={{ __html: content || "<p>No privacy policy content available. Click Edit to add some.</p>" }}
                                        />
                                    )}
                                </div>
                            </div>
