  ...
  return (
    ...
    >
      <div className="modal-dialog modal-dialog-centered modal-lg" style={{ maxWidth: "780px" }}>
        <div className="modal-content border-0" style={{ borderRadius: "12px", overflow: "hidden", boxShadow: "0 15px 40px rgba(0,0,0,0.2)" }}>
          {/* Header - Blue */}
          <div
            className="modal-header d-flex align-items-center justify-content-between py-3 px-4"
            style={{ background: "linear-gradient(135deg, #2563eb, #1e40af)", borderBottom: "none" }}
          >
              ...
              >
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (parent) {
                      parent.innerHTML = '<i class="ti ti-building-hospital" style="font-size:20px;color:#2563eb;"></i>';
                    }
                  }}
                />
              </div>
            ...
            <div className="d-flex align-items-center gap-3">
              <div className="d-flex align-items-center gap-2">
                <span
                  className={`d-inline-flex align-items-center justify-content-center rounded-circle fw-bold ${
                    step === 0 ? "text-white" : "text-white"
                  }`}
                  style={{
                    width: "28px", height: "28px", fontSize: "12px",
                    background: step === 0 ? "#2563eb" : "#10b981"
                  }}
                >
                  {step === 0 ? "1" : <i className="ti ti-check" style={{ fontSize: "14px" }} />}
                </span>
                <span className={`fw-semibold fs-13 ${step === 0 ? "text-primary" : "text-success"}`}>
                  Profile & Clinic
                </span>
              </div>
              ...
              <div className="d-flex align-items-center gap-2">
                <span
                  ...
                  style={{
                    width: "28px", height: "28px", fontSize: "12px",
                    background: step === 1 ? "#2563eb" : "#94a3b8"
                  }}
                >
                  2
                </span>
          ...
          {/* Modal Body */}
          <div className="modal-body p-0" style={{ overflowY: "auto", maxHeight: "65vh" }}>
            {step === 0 ? (
              /* ================= STEP 1 FORM ================= */
              <form onSubmit={handleNextStep1}>
                <div className="p-4">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="row g-3 align-items-start">
                      {/* Clinic Logo Upload - Same camera-plus icon pattern */}
                      <div className="col-md-3 d-flex flex-column align-items-center">
                        <div
              ...
              <div>
                      ...
                      <tbody>
                        {schedules.map((s) => (
                          <tr key={s.day} style={{ backgroundColor: !s.isActive ? "#f8fafc" : "transparent" }}>
                            ...
                            <td>
                              <span className={`badge rounded-pill px-3 py-2 ${s.isActive ? "bg-success-light text-success" : "bg-danger-light text-danger"}`}>
                ...
                {/* Actions Footer */}
                <div className="px-4 py-3 border-top bg-light d-flex justify-content-between gap-2">
